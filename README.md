2.Quản lý điểm sinh viên theo hệ tín chỉ :  Ta tổ chức các danh sách sau: 
...
- Danh sách Lop sinh viên: danh sách tuyến tính có tối đa 1000 lớp. Mỗi lớp có thông tin (MALOP (C15), TENLOP, con trỏ): con trỏ sẻ trỏ đến danh sách sinh viên thuộc lớp đó.
- Danh sách sinh viên : danh sách liên kết đơn (MASV (C15), HO, TEN,  PHAI, SODT)
- Danh sách Lop Tín chỉ: danh sách tuyến tính là 1 mảng con trỏ có tối đa 10000 lớp (MALOPTC (số nguyên tự động tăng),  MAMH, Niên khóa, Học kỳ, Nhóm, số sv min, số sv max, hủy lớp (boolean), con trỏ dssvdk): con trỏ dssv sẻ trỏ đến danh sách sinh viên  đăng ký lớp tín chỉ.
...
c. Nhập lớp, NhapSV : Cập nhập sinh viên của 1 lớp: nhập vào mã lớp trước, sau đó nhập các sinh viên vào lớp đó. 
...
l.  bảng điểm tổng kết các môn của các sinh viên thuộc 1 lớp (trong bảng điểm tổng kết chỉ hiển thị điểm thi cao nhất của từng môn của sinh viên. Kết xuất:
BẢNG ĐIỂM TỔNG KẾT
			Lớp  : <malop>    	 
